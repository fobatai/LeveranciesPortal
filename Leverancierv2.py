...
def load_css():
    ...
    .modern-card::before {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(90deg, transparent, rgba(64, 81, 137, 0.03), transparent);
        transition: 0.6s;
    }
    ...
    .modern-card:hover {
        ...
        box-shadow: 
            0 8px 30px rgba(64, 81, 137, 0.15),
    ...
    .metric-card {
        ...
        margin: 0.5rem;
        box-shadow: 
            0 4px 16px rgba(64, 81, 137, 0.08),
            inset 0 1px 0 rgba(255, 255, 255, 0.9);
        transition: all 0.3s ease;
        position: relative;
    }
    ...
    .metric-card:hover {
        ...
        box-shadow: 
            0 8px 25px rgba(64, 81, 137, 0.12),
            inset 0 1px 0 rgba(255, 255, 255, 1);
    }
    ...
    .stSelectbox > div > div > select {
        ...
        transition: all 0.3s ease;
        box-shadow: 0 2px 8px rgba(64, 81, 137, 0.05);
    }
    ...
    .stSelectbox > div > div > select:focus {
        border-color: #405189;
        box-shadow: 
            0 4px 12px rgba(64, 81, 137, 0.15),
    ...
    .css-1d391kg {
        background: rgba(255, 255, 255, 0.9);
        backdrop-filter: blur(20px);
        border-right: 1px solid rgba(64, 81, 137, 0.1);
    }
    ...
    .job-card {
        ...
        backdrop-filter: blur(20px);
        box-shadow: 
            0 6px 20px rgba(64, 81, 137, 0.08),
            inset 0 1px 0 rgba(255, 255, 255, 0.9);
        transition: all 0.3s ease;
    }
    ...
    .job-card:hover {
        transform: translateY(-2px);
        box-shadow: 
            0 10px 30px rgba(64, 81, 137, 0.12),
            inset 0 1px 0 rgba(255, 255, 255, 1);
    }
    ...
    .sync-indicator:hover {
        transform: translateY(-2px);
        box-shadow: 
            0 6px 20px rgba(64, 81, 137, 0.12),
            inset 0 1px 0 rgba(255, 255, 255, 1);
    }
    ...
    .login-container {
        ...
        border: 1px solid rgba(64, 81, 137, 0.1);
        box-shadow: 
            0 10px 40px rgba(64, 81, 137, 0.15),
            inset 0 1px 0 rgba(255, 255, 255, 0.9);
        position: relative;
        transition: all 0.3s ease;
    }
    ...
    .login-container:hover {
        transform: translateY(-2px);
        box-shadow: 
            0 15px 50px rgba(64, 81, 137, 0.2),
            inset 0 1px 0 rgba(255, 255, 255, 1);
    }
    ...
    .modern-footer {
        ...
        border-radius: 16px;
        border: 1px solid rgba(64, 81, 137, 0.1);
        box-shadow: 0 4px 16px rgba(64, 81, 137, 0.05);
    }
    
    /* Professional loading spinner */
    .loading-spinner {
        border: 3px solid rgba(64, 81, 137, 0.2);
        border-radius: 50%;
        ...
        margin: 0 auto;
        box-shadow: 0 0 15px rgba(64, 81, 137, 0.3);
    }
